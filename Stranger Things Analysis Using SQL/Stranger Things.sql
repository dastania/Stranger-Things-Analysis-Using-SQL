...
Select hometown,count(character_id) as cnt from characters group by hometown order by cnt desc; 
...
group by character_name,season;
...
Select round(avg(age)) from characters where hometown="Hawkins";
